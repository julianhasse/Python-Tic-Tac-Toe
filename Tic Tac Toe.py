#Tic Tac Toe Game Python - Julian Hasse - 2021
from subprocess import call # to be able to clear terminal
from termcolor import colored # color terminal characters
...
def printBoard():
    _ = call('clear') # clear the terminal before updating the board
    ...
    print(colored('-----------', 'red'))
    print(colored('   |   |', 'red'))
    print(colored(' ' + board[4] + ' | ' + board[5] + ' | ' + board[6], 'red'))
    print(colored('   |   |', 'red'))
    print(colored('-----------', 'red'))
    print(colored('   |   |', 'red'))
    print(colored(' ' + board[7] + ' | ' + board[8] + ' | ' + board[9], 'red'))
    print(colored('   |   |', 'red'))
...
def main():
    ...
    if isBoardFull(board):
        print(colored('Game is a tie! No more spaces left to move.', 'red'))
main()
